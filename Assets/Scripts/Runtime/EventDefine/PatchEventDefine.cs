...
public class PatchEventDefine
{
    ...
    /// 补丁流程步骤改变
    /// </summary>
    public class PatchStepChange : IEventMessage
    {
        public string Tips;

        public static void SendEventMessage(string tips)
        {
            var msg = new PatchStepChange();
            msg.Tips = tips;
            UniEvent.SendMessage(msg);
        }
    }
    ...
    public class DownloadUpdate : IEventMessage
    {
        ...
        public long TotalDownladSizeBytes;
        ...
        public static void SendEventMessage(DownloadUpdateData updateData)
        {
            ...
            msg.TotalDownladSizeBytes = updateData.TotalDownloadBytes;
